...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#
"""A submodule, existing only for demonstration purposes, to show the concept of
the logger setup and running a pytest.
"""
...
def generate_int_list(x: int = 3) -> list[int]:
    """Generate a list of integers from 1 to x.
